...
import physics from "../../circuit-rush/public/static/physics";
      ...
      >
        <group position={[0, 0, 0]}>
          {cubesArray.map((cubeParams, index) => (
            <Cube
              key={index}
              position={cubeParams.slice(0, 3)}
              rotation={[0, (cubeParams[3] * Math.PI) / 180, 0]}
              size={cubeParams.slice(4)}
            />
          ))}
        </group>
      </Instances>
